            ...
            <CardContent className={classes.container}>
                <Grid container>
                    <Grid lg={5} md={5} sm={5} xs={12} item>
                        <img src={article.url} className={classes.image} alt="articleImg"/>
                    </Grid>
                    <Grid lg={7} md={7} sm={7} xs={12} item className={classes.rightContainer}>
                        ...
                        <Typography className={classes.author}>
                            <b className={classes.short}>Prepared</b> by {article.author} / {new Date(article.timestamp).toDateString()}
                        </Typography>
                        <Typography className={classes.description}>{article.description}</Typography>
                        <Typography className={classes.publisher}>
                            explore more at <a href={article.link} target='_blank' rel="noreferrer">{article.publisher}</a>
                        </Typography>
                    </Grid>
                </Grid>
            </CardContent>
